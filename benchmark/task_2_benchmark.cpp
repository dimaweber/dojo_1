...
BENCHMARK(bm_task_2<gcd_knuth>)->ThreadPerCpu( )->Complexity( )->Unit(benchmark::kMillisecond);
BENCHMARK(bm_task_2<gcd_schmidt>)->ThreadPerCpu( )->Complexity( )->Unit(benchmark::kMillisecond);
BENCHMARK(bm_task_2<gcd_stepanov>)->ThreadPerCpu( )->Complexity( )->Unit(benchmark::kMillisecond);
BENCHMARK(bm_task_2<gcd_opt>)->ThreadPerCpu( )->Complexity( )->Unit(benchmark::kMillisecond);

BENCHMARK(bm_task_2_special<cpp_standard>)->ThreadPerCpu( )->Unit(benchmark::kNanosecond)->Repetitions(100);
BENCHMARK(bm_task_2_special<gcd_no_rec>)->ThreadPerCpu( )->Unit(benchmark::kNanosecond)->Repetitions(100);
BENCHMARK(bm_task_2_special<gcd_knuth>)->ThreadPerCpu( )->Unit(benchmark::kNanosecond)->Repetitions(100);
BENCHMARK(bm_task_2_special<gcd_schmidt>)->ThreadPerCpu( )->Unit(benchmark::kNanosecond)->Repetitions(100);
BENCHMARK(bm_task_2_special<gcd_stepanov>)->ThreadPerCpu( )->Unit(benchmark::kNanosecond)->Repetitions(100);
BENCHMARK(bm_task_2_special<gcd_opt>)->ThreadPerCpu( )->Unit(benchmark::kNanosecond)->Repetitions(100);
